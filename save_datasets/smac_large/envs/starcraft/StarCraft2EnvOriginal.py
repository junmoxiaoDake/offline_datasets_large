...
class StarCraft2EnvOriginal(MultiAgentEnv):
    ...
    def step(self, actions):
        ...
        step_1_time = step_1_end_time - step_1_start_time
        # Send action request
        ...
        step_2_time = step_2_end_time - step_2_start_time
        ...
        step_3_time = step_3_end_time - step_3_start_time

        return reward, terminated, info, step_1_time, step_2_time, step_3_time, update_time
